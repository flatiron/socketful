...
exports.init = function (done) {
  var app = this;
  //
  // TODO: better integration when using as Flatiron plugin:
  //
  //     app.use(flatiron.plugins.socketful);
  //
  if (app.resources) {
   // return socketful.createServer(app.resources, { server: app.server }, done);
  }
  done();
};